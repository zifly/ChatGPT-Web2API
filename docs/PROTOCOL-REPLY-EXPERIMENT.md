...
Live follow-up: one local synthetic JSON request was exactly preserved. Six NAS business requests over three repeated samples passed structure and candidate checks, including three through the review page. No independent same-turn protocol-original comparison was captured for those business requests. See [validation details](../README.md), [English installation](../NAS-INSTALLATION.md) and [English API guide](../API-USAGE.md).
